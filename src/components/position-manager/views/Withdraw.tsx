...
export const Withdraw: React.FC<WithdrawProps> = () => {
    ...
    if (collateralState && syntheticState && empState && positionState && totalsState && latestPrice) {
        // position
        const { syntheticTokens: positionTokens, collateral: positionCollateral, withdrawalAmount, withdrawalPassTime, pendingWithdraw } = positionState
        ...
        const isLiquidationPriceDangerouslyFarBelowCurrentPrice =
            ...
            (1 - LIQUIDATION_PRICE_WARNING_THRESHOLD) * latestPrice;

        // Fast withdrawal amount: can withdraw instantly as long as CR > GCR
        const fastWithdrawableCollateral = positionCollateralAsNumber > gcrAsNumber * positionTokensAsNumber
            ? (positionCollateralAsNumber - gcrAsNumber * positionTokensAsNumber).toFixed(4) : "0";
        ...
        const resultantCRBelowRequirement =
            ...
            parseFloat(pricedResultantCR) < collateralRequirementFromWei;
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={8}>
                                    <Typography>
                                        ...
                                        {`${withdrawAmountAsNumber} ${collateralSymbol}`}
                                    </Typography>
                                </Grid>
                                ...
                                <Grid item xs={8}>
                                    <Typography>
                                        ...
                                        prior to the EMP expiration.
                                    </Typography>
                                </Grid>

                                <Grid item xs={8}>
                                    <Typography>
                                        Post expiry, the only way to
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={8}>
                                    <Typography>
                                        ...
                                        <br></br>
                                        <strong>Requested withdrawal amount: </strong>{" "}
                                        {`${withdrawalAmount} ${collateralSymbol}`}
                                    </Typography>
                                </Grid>
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item md={10} sm={10} xs={10}>
                            <TextField
                                ...
                                helperText={
                                    withdrawAboveBalance && `Your locked ${collateralSymbol} is too low`
                                }
                                value={collateral}
