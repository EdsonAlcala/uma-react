    ...
    const getCoingeckoInfo = async () => {
      try {
        ...
        const totalValueLocked = Number(
          marketData.total_value_locked["usd"]
        ).toLocaleString("en-US", {
          style: "currency",
          currency: "USD",
        });
        const marketCap = Number(marketData.market_cap["usd"]).toLocaleString(
          "en-US",
          {
            style: "currency",
            currency: "USD",
        ...
        const totalSupply = Number(marketData.total_supply).toLocaleString(
          "en-US"
        );
